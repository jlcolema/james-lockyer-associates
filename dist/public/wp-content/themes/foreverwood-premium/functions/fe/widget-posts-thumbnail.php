<?php
/**
 * Plugin Name: ForeverWood Posts-Thumbnail Widget
 * Description: Displays the latest posts from the selected category as the thumbnails.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("foreverwood_homepage_thumbnail");'));
class foreverwood_homepage_thumbnail extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'homepage-thumbnail-posts', 'description' => __('Displays the latest posts from the selected category as the thumbnails.', 'foreverwood') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('foreverwoodthumbnail', __('ForeverWood Posts-Thumbnail', 'foreverwood'), $widget_ops, $control_ops);
	}
