...
if ( ! class_exists( 'foreverwood_Wp_Plugins_v301' ) )
	require_once( 'wp-display-header-functions.php' );


register_activation_hook( __FILE__, array(
	'foreverwood_Wp_Display_Header',
	'activation'
) );


class foreverwood_Wp_Display_Header extends foreverwood_Wp_Plugins_v301 {
	 ...
	 * @access public
	 *
	 * @return foreverwood_Wp_Display_Header
	 */
	...
	public function register_scripts_styles() {
		...
		wp_register_style(
			$this->textdomain,
			get_template_directory_uri() . '/functions/fe/wp-display-header/css/wp-display-header.css',
			array(),
			$plugin_data['Version']
		);
	}
...
} // End of class foreverwood_Wp_Display_Header.
 ...
 * @return void
 */
function foreverwood_wpdh_instantiate() {

	if ( current_theme_supports( 'custom-header' ) )
		new foreverwood_Wp_Display_Header;
}
add_action( 'init', 'foreverwood_wpdh_instantiate', 1 );
