...
class foreverwood_Wp_Plugins_v301 {
	...
	public function __construct( $args = array() ) {
		...
		load_plugin_textdomain( 'foreverwood-wp', false, $this->textdomain . '/lang' );
	...
	public function parent_plugins_loaded() {
		...
		if ( ! has_action( 'foreverwood_side_info_column' ) ) {
			$this->hook( 'foreverwood_side_info_column', 'feed_box'      );
		}
	}
...
} // End of class foreverwood_Wp_Plugins
