...
<div id="comments" class="comments-area<?php if ( $foreverwood_next_preview_post == 'Display' && $foreverwood_display_related_posts == 'Hide' && $foreverwood_display_related_posts != '' ) { ?> comments-area-post<?php } ?><?php if ( $foreverwood_next_preview_post == 'Hide' && $foreverwood_share_buttons_post == 'Hide' ) { ?> comments-area-post-hide<?php } ?><?php if ( $foreverwood_share_buttons_page == 'Hide' ) { ?> comments-area-page-hide<?php } ?>">
