...
class meadowhill_Wp_Plugins_v301 {
	...
	public function __construct( $args = array() ) {
		...
		load_plugin_textdomain( 'meadowhill-wp', false, $this->textdomain . '/lang' );
	...
	public function parent_plugins_loaded() {
		...
		if ( ! has_action( 'meadowhill_side_info_column' ) ) {
			$this->hook( 'meadowhill_side_info_column', 'feed_box'      );
		}
	}
...
} // End of class meadowhill_Wp_Plugins
