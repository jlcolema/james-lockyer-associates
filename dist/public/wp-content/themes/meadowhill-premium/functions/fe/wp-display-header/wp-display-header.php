...
if ( ! class_exists( 'meadowhill_Wp_Plugins_v301' ) )
	require_once( 'wp-display-header-functions.php' );


register_activation_hook( __FILE__, array(
	'meadowhill_Wp_Display_Header',
	'activation'
) );


class meadowhill_Wp_Display_Header extends meadowhill_Wp_Plugins_v301 {
	 ...
	 * @access public
	 *
	 * @return meadowhill_Wp_Display_Header
	 */
...
} // End of class meadowhill_Wp_Display_Header.
 ...
 * @return void
 */
function meadowhill_wpdh_instantiate() {

	if ( current_theme_supports( 'custom-header' ) )
		new meadowhill_Wp_Display_Header;
}
add_action( 'init', 'meadowhill_wpdh_instantiate', 1 );
