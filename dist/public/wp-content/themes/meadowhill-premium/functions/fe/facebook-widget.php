<?php
/**
 * Plugin Name: MeadowHill Facebook Like Box Widget
...
class Headerbar extends WP_Widget {
	function Headerbar() {
		$widget_ops = array('classname' => 'facebook-like-box', 'description' => __('Displays Facebook Like Box.', 'meadowhill') );
		$control_ops = array('width' => 200, 'height' => 400);
		$this->WP_Widget('meadowhillhead', __('MeadowHill Facebook Like Box Widget', 'meadowhill'), $widget_ops, $control_ops);
	}
...
<p>
	<label for="<?php echo $this->get_field_id('likeurl'); ?>">
		<?php _e('Facebook Page URL:', 'meadowhill'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;">
	<?php _e('Insert here the full URL of your Facebook Page that will be liked (example: http://www.facebook.com/FacebookDevelopers).', 'meadowhill'); ?>
</p>
</p>
<!-- Height -->
<p>
	<label for="<?php echo $this->get_field_id('boxheight'); ?>">
		<?php _e('Like Box Height: (optional)', 'meadowhill'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;">
	<?php _e('Insert here the height of Like Box. The value is in pixels, but in the field please write ONLY NUMBERS (without symbol "px")!', 'meadowhill'); ?>
</p>
</p>
<!-- Show Faces -->
<p>
	<label for="<?php echo $this->get_field_id('showfaces'); ?>">
		<?php _e('Show Faces:', 'meadowhill'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;">
	<?php _e('Specify whether to display profile photos of people who like the page.', 'meadowhill'); ?>
</p>
</p>
<!-- Show Stream -->
<p>
	<label for="<?php echo $this->get_field_id('showstream'); ?>">
		<?php _e('Show Stream:', 'meadowhill'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;">
	<?php _e('Specify whether to display a stream of the latest posts by the Page.', 'meadowhill'); ?>
</p>
</p>
<?php 
