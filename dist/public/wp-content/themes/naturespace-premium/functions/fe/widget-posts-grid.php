<?php
/**
 * Plugin Name: NatureSpace Posts-Grid Widget
 * Description: Displays the latest posts from the selected category as a grid.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("naturespace_homepage_grid");'));
class naturespace_homepage_grid extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'homepage-grid-posts', 'description' => __('Displays the latest posts from the selected category as a grid.', 'naturespace') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('naturespacegrid', __('NatureSpace Posts-Grid', 'naturespace'), $widget_ops, $control_ops);  
	}
