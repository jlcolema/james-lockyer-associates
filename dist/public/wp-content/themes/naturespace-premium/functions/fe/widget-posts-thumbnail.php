<?php
/**
 * Plugin Name: NatureSpace Posts-Thumbnail Widget
 * Description: Displays the latest posts from the selected category as the thumbnails.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("naturespace_homepage_thumbnail");'));
class naturespace_homepage_thumbnail extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'homepage-thumbnail-posts', 'description' => __('Displays the latest posts from the selected category as the thumbnails.', 'naturespace') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('naturespacethumbnail', __('NatureSpace Posts-Thumbnail', 'naturespace'), $widget_ops, $control_ops);
	}
...
<?php if ( has_post_thumbnail() ) : ?>
        ...
        <a href="<?php echo get_permalink(); ?>" title="<?php the_title(); ?>"><span class="thumbnail-hover" aria-hidden="true"><i class="icon_zoom-in_alt" aria-hidden="true"></i></span><?php the_post_thumbnail( 'thumbnail-thumb' ); ?></a>
        </article>
<?php endif; ?>
<?php endwhile; endif; ?>
<?php wp_reset_query(); ?>
