...
class naturespace_Wp_Plugins_v301 {
	...
	public function __construct( $args = array() ) {
		...
		load_plugin_textdomain( 'naturespace-wp', false, $this->textdomain . '/lang' );
	...
	public function parent_plugins_loaded() {
		...
		if ( ! has_action( 'naturespace_side_info_column' ) ) {
			$this->hook( 'naturespace_side_info_column', 'feed_box'      );
		}
	}
...
} // End of class naturespace_Wp_Plugins
