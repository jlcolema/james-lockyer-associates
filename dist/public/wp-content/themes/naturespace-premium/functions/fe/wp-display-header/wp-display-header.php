...
if ( ! class_exists( 'naturespace_Wp_Plugins_v301' ) )
	require_once( 'wp-display-header-functions.php' );


register_activation_hook( __FILE__, array(
	'naturespace_Wp_Display_Header',
	'activation'
) );


class naturespace_Wp_Display_Header extends naturespace_Wp_Plugins_v301 {
	 ...
	 * @access public
	 *
	 * @return naturespace_Wp_Display_Header
	 */
...
} // End of class naturespace_Wp_Display_Header.
 ...
 * @return void
 */
function naturespace_wpdh_instantiate() {

	if ( current_theme_supports( 'custom-header' ) )
		new naturespace_Wp_Display_Header;
}
add_action( 'init', 'naturespace_wpdh_instantiate', 1 );
