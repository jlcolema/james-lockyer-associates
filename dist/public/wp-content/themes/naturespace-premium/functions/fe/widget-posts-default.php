<?php
/**
 * Plugin Name: NatureSpace Posts-Default Widget
 * Description: Displays the latest posts from the selected category in the default manner.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("naturespace_homepage_default");'));
class naturespace_homepage_default extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'homepage-default-posts', 'description' => __('Displays the latest posts from the selected category in the default manner.', 'naturespace') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('naturespacedefault', __('NatureSpace Posts-Default', 'naturespace'), $widget_ops, $control_ops);
	}
