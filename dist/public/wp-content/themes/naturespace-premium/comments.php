...
<div id="comments" class="comments-area<?php if ( $naturespace_next_preview_post == 'Display' && $naturespace_display_related_posts == 'Hide' && $naturespace_display_related_posts != '' ) { ?> comments-area-post<?php } ?><?php if ( $naturespace_next_preview_post == 'Hide' && $naturespace_share_buttons_post == 'Hide' ) { ?> comments-area-post-hide<?php } ?><?php if ( $naturespace_share_buttons_page == 'Hide' ) { ?> comments-area-page-hide<?php } ?>">
