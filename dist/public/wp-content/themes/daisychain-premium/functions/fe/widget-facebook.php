...
class daisychain_facebook extends WP_Widget {
	function __construct() {
		...
		parent::__construct('daisychainhead', __('DaisyChain Facebook Like Box Widget', 'daisychain'), $widget_ops, $control_ops);
	}
...
<p>
	<label for="<?php echo $this->get_field_id('boxwidth'); ?>">
		<?php _e('Like Box Width: (optional)', 'daisychain'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert here the width of Like Box. The value is in pixels, but in the field please write ONLY NUMBERS (without symbol "px") between 180 - 500!', 'daisychain'); ?>
</p>
</p>
<!-- Show Faces -->
<p>
