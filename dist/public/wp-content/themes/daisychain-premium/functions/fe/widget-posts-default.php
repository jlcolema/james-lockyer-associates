<?php
/**
 * Plugin Name: DaisyChain Posts-Default Widget
 * Description: Displays the latest posts from the selected category in the default manner.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("daisychain_homepage_default");'));
class daisychain_homepage_default extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'homepage-default-posts', 'description' => __('Displays the latest posts from the selected category in the default manner.', 'daisychain') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('daisychaindefault', __('DaisyChain Posts-Default', 'daisychain'), $widget_ops, $control_ops);
	}
