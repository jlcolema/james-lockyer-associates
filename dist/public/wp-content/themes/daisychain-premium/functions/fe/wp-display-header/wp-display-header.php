...
if ( ! class_exists( 'daisychain_Wp_Plugins_v301' ) )
	require_once( 'wp-display-header-functions.php' );


register_activation_hook( __FILE__, array(
	'daisychain_Wp_Display_Header',
	'activation'
) );


class daisychain_Wp_Display_Header extends daisychain_Wp_Plugins_v301 {
	 ...
	 * @access public
	 *
	 * @return daisychain_Wp_Display_Header
	 */
...
} // End of class daisychain_Wp_Display_Header.
 ...
 * @return void
 */
function daisychain_wpdh_instantiate() {

	if ( current_theme_supports( 'custom-header' ) )
		new daisychain_Wp_Display_Header;
}
add_action( 'init', 'daisychain_wpdh_instantiate', 1 );
