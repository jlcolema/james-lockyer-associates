<?php
/**
 * Plugin Name: LiveRide Social Widget
 * Description: Display links to profiles on the most popular social networks.
 * Author: WPlook Team and Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("liveridesocial");'));
class liveridesocial extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'liveridesocial', 'description' => __('A Social widget by LiveRide', 'liveride') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('liveridetsoc', __('LiveRide Social Widget', 'liveride'), $widget_ops, $control_ops);
	}
...
if ( $instance ) {
	...
	if ( $instance ) {
		...
		if ( $instance ) {
			...
			$linkedin = __( '', 'liveride' );
		} 
        if ( $instance ) {
			$delicious = esc_attr( $instance[ 'delicious' ] );
		}
		else {
			$delicious = __( '', 'liveride' );
		} 
        if ( $instance ) {
			$pinterest = esc_attr( $instance[ 'pinterest' ] );
		}
		else {
			$pinterest = __( '', 'liveride' );
		}
     	 if ( $instance ) {
...
<p>
	<label for="<?php echo $this->get_field_id('twitter'); ?>"> <img style="float: left; margin: 0 5px 0px 0; width: 12px; height: 12px;" src="<?php echo get_template_directory_uri()  ?>/functions/be/images/icons/twitter.png" />
		<?php _e('Twitter:', 'liveride'); ?>
	</label>
	<input class="widefat" id="<?php echo $this->get_field_id('twitter'); ?>" name="<?php echo $this->get_field_name('twitter'); ?>" type="text" value="<?php echo $twitter; ?>" />
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Twitter profile.', 'liveride'); ?>
</p>
</p>
<!-- Facebook-->
<p>
	<label for="<?php echo $this->get_field_id('facebook'); ?>"> <img style="float: left; margin: 0 5px 0px 0; width: 12px; height: 12px;" src="<?php echo get_template_directory_uri()  ?>/functions/be/images/icons/facebook.png" />
		<?php _e('Facebook:', 'liveride'); ?>
	</label>
	<input class="widefat" id="<?php echo $this->get_field_id('facebook'); ?>" name="<?php echo $this->get_field_name('facebook'); ?>" type="text" value="<?php echo $facebook; ?>" />
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Facebook profile, page or group.', 'liveride'); ?>
</p>
</p>
<!-- RSS-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the Url of your RSS. You may include your RSS from Feedburner.', 'liveride'); ?>
</p>
</p>
<!-- Google Plus-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Google Plus profile', 'liveride'); ?>
</p>
</p>
<!-- You Tube-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your YouTube profile.', 'liveride'); ?>
</p>
</p>
<!-- Linkedin-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Linkedin profile.', 'liveride'); ?>
</p>
</p>
<!-- Delicious-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Delicious profile.', 'liveride'); ?>
</p>
</p>
<!--Pinterest-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Pinterest profile.', 'liveride'); ?>
</p>
</p>
<!-- Flickr-->
<p>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert the full URL of your Flickr profile.', 'liveride'); ?>
</p>
</p>
<?php 
...
<?php if ( $title )
    ...
    // Facebook
		...
		// You Tube
		if ($youtube != "") {
			echo "<div class='social-item'>"."<a href='$youtube'><img src=\"". get_template_directory_uri()  ."/images/icons/youtube.png\" alt=\"You Tube \" /></a><p><a href='$youtube'>YouTube</a></p>" ."</div>";
		}			
		// Linkedin
		if ($linkedin != "") {
