...
class liveride_Wp_Plugins_v301 {
	...
	public function __construct( $args = array() ) {
		...
		load_plugin_textdomain( 'liveride-wp', false, $this->textdomain . '/lang' );
	...
	public function parent_plugins_loaded() {
		...
		if ( ! has_action( 'liveride_side_info_column' ) ) {
			$this->hook( 'liveride_side_info_column', 'feed_box'      );
		}
	}
...
} // End of class liveride_Wp_Plugins
