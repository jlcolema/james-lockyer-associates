<?php
/**
 * Plugin Name: LiveRide Facebook Like Box Widget
 * Description: Displays the Facebook Like Box.
 * Author: Tomas Toman	
 * Version: 1.1
*/

add_action('widgets_init', create_function('', 'return register_widget("liveride_facebook");'));
class liveride_facebook extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'facebook-like-box', 'description' => __('Displays Facebook Like Box.', 'liveride') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('liveridehead', __('LiveRide Facebook Like Box Widget', 'liveride'), $widget_ops, $control_ops);
	}
...
<p>
	<label for="<?php echo $this->get_field_id('likeurl'); ?>">
		<?php _e('Facebook Page URL:', 'liveride'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert here the full URL of your Facebook Page that will be liked (example: http://www.facebook.com/FacebookDevelopers).', 'liveride'); ?>
</p>
</p>
<!-- Height -->
<p>
	<label for="<?php echo $this->get_field_id('boxheight'); ?>">
		<?php _e('Like Box Height: (optional)', 'liveride'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert here the height of Like Box. The value is in pixels, but in the field please write ONLY NUMBERS (without symbol "px")!', 'liveride'); ?>
</p>
</p>
<!-- Width -->
<p>
	<label for="<?php echo $this->get_field_id('boxwidth'); ?>">
		<?php _e('Like Box Width: (optional)', 'liveride'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Insert here the width of Like Box. The value is in pixels, but in the field please write ONLY NUMBERS (without symbol "px") between 180 - 500!', 'liveride'); ?>
</p>
</p>
<!-- Show Faces -->
<p>
	<label for="<?php echo $this->get_field_id('showfaces'); ?>">
		<?php _e('Show Faces:', 'liveride'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Specify whether to display profile photos of people who like the page.', 'liveride'); ?>
</p>
</p>
<!-- Show Stream -->
<p>
	<label for="<?php echo $this->get_field_id('showstream'); ?>">
		<?php _e('Show Stream:', 'liveride'); ?>
	</label>
...
<p style="font-size: 10px; color: #999; margin: 0; padding: 0px;">
	<?php _e('Specify whether to display a stream of the latest posts by the Page.', 'liveride'); ?>
</p>
</p>
<?php 
