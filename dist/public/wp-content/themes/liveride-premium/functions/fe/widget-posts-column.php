<?php
/**
 * Plugin Name: LiveRide Posts-Column Widget
 * Description: Displays the latest posts from the selected category as a column with highlighted first post.
 * Author: Tomas Toman	
 * Version: 1.0
*/

add_action('widgets_init', create_function('', 'return register_widget("liveride_homepage_column");'));
class liveride_homepage_column extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'homepage-column-posts', 'description' => __('Displays the latest posts from the selected category as a column with highlighted first post.', 'liveride') );
		$control_ops = array('width' => 200, 'height' => 400);
		parent::__construct('liveridecolumn', __('LiveRide Posts-Column', 'liveride'), $widget_ops, $control_ops);
	}
